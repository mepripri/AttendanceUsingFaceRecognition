    ...
    def callback4():
        ...
        if(a==1):
            ...
            if(isRecordExist1==1):
                top.destroy()
                top3=Toplevel()
                top3.geometry('1370x1000')
                top3.configure(bg="#b56969")

                text = Label(top3, text="ATTENDENCE USING FACE RECOGNITION",fg="#e8edf3",bg="#22264b",width=44,height=2,font=("Courier", 50),anchor="center")
                text.place(x=0,y=0)
                ...
                b6 = Button(top3, text="VIEW ATTENDANCE", command=callback8,relief=RAISED,width=20,fg="#22264b",bg='#e6cf8b',font=("Courier", 30))
                b6.pack()
            ...
            if(isRecordExist2!=1):
                ...
                text = Label(top4, text="ATTENDENCE USING FACE RECOGNITION",fg="#e8edf3",bg="#22264b",width=44,height=2,font=("Courier", 50),anchor="center")
                text.place(x=0,y=0)
                ...
                if(a==1):
                    ...
                    if(isRecordExist==1):
                        ...
                        def callback():
                            ...
                            text = Label(top1, text="Datasets are Trained...",fg="#e8edf3",bg="#22264b",width=45,height=1,font=("Courier", 50),anchor="center")
                            text.place(x=0,y=880)  

                        b1= Button(top1, text="DATASET COLLECTION", command=callback,relief=RAISED,width=20,fg="#22264b",bg='#e6cf8b',font=("Courier", 30))
                        b1.pack()
                        b1.place(x=630,y=830,anchor="e",height=50,width=500)
                        ...
                        b2 = Button(top1, text="FACE RECOGNIZER", command=callback2,relief=RAISED,width=20,fg="#22264b",bg='#e6cf8b',font=("Courier", 30))
                        b2.pack()
                        b2.place(x=1230,y=830,anchor="e",height=50,width=500)
                    else:
                        print("Error")
